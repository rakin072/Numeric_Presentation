...
![False Position Method](Images/Screenshot%202025-12-22%20043936.png)
...
#### Secant Output
```
func : 1x^4+0x^3-5x^2+0x+4
search interval for root 1 :[ -2.3	-1.85 ]
root 1 : -2
Iteration needed : 4
search interval for root 2 :[ -1.4	-0.95 ]
root 2 : -1
Iteration needed : 2
search interval for root 3 :[ 0.85	1.3 ]
root 3 : 1
Iteration needed : 3
search interval for root 4 :[ 1.75	2.2 ]
root 4 : 2
Iteration needed : 4
